...
// clang-format off
    ...
    #define DISABLE_WARNING_UNUSED_LOCAL_VARIABLE   DISABLE_WARNING(4189)
    ...
    #define DISABLE_WARNING_UNUSED_LOCAL_VARIABLE   DISABLE_WARNING(-Wunused-variable)
    ...
    #define DISABLE_WARNING_UNUSED_LOCAL_VARIABLE
