...
namespace
{
	...
	[[nodiscard]] constexpr const char* returnCharFromEncoding(MRG::Encoding encoding)
	{
		switch (encoding) {
...
namespace MRG::OpenGL
{
	...
	void Shader::uploadUniform(const std::string& name, int value) const
	{
		MRG_PROFILE_FUNCTION()
	...
	void Shader::uploadUniform(const std::string& name, int* value, std::size_t count) const
	{
		MRG_PROFILE_FUNCTION()
	...
	void Shader::uploadUniform(const std::string& name, float value) const
	{
		MRG_PROFILE_FUNCTION()
	...
	void Shader::uploadUniform(const std::string& name, const glm::vec2& value) const
	{
		MRG_PROFILE_FUNCTION()
	...
	void Shader::uploadUniform(const std::string& name, const glm::vec3& value) const
	{
		MRG_PROFILE_FUNCTION()
	...
	void Shader::uploadUniform(const std::string& name, const glm::vec4& value) const
	{
		MRG_PROFILE_FUNCTION()
	...
	void Shader::uploadUniform(const std::string& name, const glm::mat3& matrix) const
	{
		MRG_PROFILE_FUNCTION()
