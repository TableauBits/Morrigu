...
/************ WINDOWS ONLY SECTION ************************/
	...
	/* windows only - utf-16 version */
	wchar_t* tinyfd_saveFileDialogW(wchar_t const* aTitle,                    /* NULL or L"" */
	...
	/* windows only - utf-16 version */
	wchar_t*
	tinyfd_openFileDialogW(wchar_t const* aTitle,                   /* NULL or L"" */
	                       wchar_t const* aDefaultPathAndFile,      /* NULL or L"" */
	                       int aNumOfFilterPatterns,                /* 0 (2 in the following example) */
	...
	/* windows only - utf-16 version */
	wchar_t* tinyfd_colorChooserW(wchar_t const* aTitle,              /* NULL or L"" */
